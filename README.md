...
Проект тестировался в отдельном окружении MMPose с именем `.venv-mmpose`.
...
Установка MMPose/MMCV чувствительна к версиям CUDA, PyTorch и Python. Проверенный стек был основан на:
